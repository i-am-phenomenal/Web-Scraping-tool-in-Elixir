...
var channel = socket.channel("live_data:lobby", {});
...
var questionShout = $("#question-added-msg");

channel.on("question-added", function (payload) {
  questionShout.show();
  // questionShout.append("New Question added")
});

channel.on("answer-marked-correct", function (payload) {
